...
- (instancetype)init {
    ...
    // 设置是否固定在屏幕
//    if (self.lockedToScreen) {
//    _annotation.lockedToScreen = YES;
//    _annotation.lockedScreenPoint = CGPointMake(_mapView.bounds.size.width / 2, _mapView.bounds.size.height / 2);
//    }
...
////    self.lockedToScreen = lockedToScreen;
//    // 设置是否固定在屏幕
//    if (lockedToScreen) {
//        self.lockedToScreen = lockedToScreen;
//        _annotation.lockedToScreen = lockedToScreen;
//        _annotation.lockedScreenPoint = CGPointMake(_mapView.bounds.size.width / 2, _mapView.bounds.size.height / 2);
//
//    }
//}
